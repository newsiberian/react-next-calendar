...
export const FirstOfTheWeekAllDayEvent = () => (
  <Calendar
...
export const EndOfTheWeekAllDayEvent = () => (
  <Calendar
...
export const EventAtStartOfWeek = () => (
  <Calendar
    defaultDate={new Date(2016, 11, 4)}
    events={[
      {
...
export const EventsOnConstrainedDayColumn = () => (
  <Calendar
    defaultView={Views.DAY}
